#include "Gex_app/include/PythonInterpreter.h"
...
void GexApp::Highlighter::DoMatch(const QString& exp, const QString& text,
...
void GexApp::Highlighter::highlightBlock(const QString &text)
{
...
GexApp::PythonInterpreter::PythonInterpreter(QWidget* parent): QDockWidget(parent)
{
...
void GexApp::PythonInterpreter::Write(std::string str)
{
...
void GexApp::PythonInterpreter::RunCurrentEditorCode()
{
...
GexApp::PyOutputCallback::PyOutputCallback(
...
void GexApp::PyOutputCallback::ReceiveEvent(
...
void GexApp::PythonInterpreter::Initialize()
{
    handle = Gex::Python::Interpreter::AcquireInterpreter();

    int res = PyRun_SimpleString("import App\n"
                                 "import sys\n"
                                 "sys.stdout = App.PythonOutput\n"
                                 "sys.stderr = App.PythonOutput"
                                 );
    if (res)
    {
        PyErr_Print();
    ...
    auto output = Gex::App::PythonOutput::GetInstance();
