...
Gex::App::MainWindow::MainWindow(Gex::CompoundNodePtr graph_, std::string file,
                                 QWidget* parent): QMainWindow(parent)
{
    ...
    {
        Gex::App::SelectionContext::Select(sel);
    };

    QObject::connect(graphWidget, &Gex::Ui::GraphWidget::SelectedNodeChanged, selCb);

    interpreter = new GexApp::PythonInterpreter(this);
    ...
    auto selectionGetter = [](){
        return App::SelectionContext::Selection();
    };
...
//                        "Open", this, &MainWindow::New);
    ...
    App::AppContext::SetMainWindow(this);
}


Gex::Feedback Gex::App::MainWindow::New()
{
...
Gex::Feedback Gex::App::MainWindow::Open(const std::string& file)
{
    Gex::Feedback feedback;
...
Gex::Feedback Gex::App::MainWindow::SaveAs(const std::string& file)
{
    Gex::Feedback f;
...
Gex::Feedback Gex::App::MainWindow::Save()
{
...
void Gex::App::MainWindow::NewCallback()
{
    New();
}


void Gex::App::MainWindow::OpenCallback()
{
...
void Gex::App::MainWindow::SaveAsCallback()
{
...
void Gex::App::MainWindow::SaveCallback()
{
    Save();
}
...
void Gex::App::MainWindow::ShowMessage(const Gex::Feedback& feedback) const
{
...
void Gex::App::MainWindow::LoadPlugin()
{
    std::string dir;
    ...
    QFileDialog dialog(this, "Load plugin", dir.c_str(), "*.json");
...
void Gex::App::MainWindow::Undo() const
{
...
void Gex::App::MainWindow::Redo() const
{
...
Gex::CompoundNodePtr Gex::App::MainWindow::CurrentNode() const
{
    return graph;
}